var _day_key = (keyboard_check_pressed(ord("T")) || external_day_press) && can_toggle_day;

if (_day_key) {
    time_pause = !time_pause;
    can_toggle_day = false;
} else if (!keyboard_check(ord("T")) && !external_day_press) {
    can_toggle_day = true; // Allow toggling again once the key is released
}

external_day_press = false; // Reset external flag to prevent multiple toggles
