if(room == rm_level_1) {
	...
	vol_bg_fishing = audio_sound_get_gain(snd_bg_fishing);
...
if(room == rm_farm || room == rm_farm_house || room == rm_farm_upstair || room == rm_forest) {
	...
	audio_play_sound(snd_bg_farm, 0, 0.3);
	
	vol_bg_farm = audio_sound_get_gain(snd_bg_farm);
}
